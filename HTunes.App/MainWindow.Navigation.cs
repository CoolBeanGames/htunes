...
public partial class MainWindow
{
    ...
    private void InitializeNavigation()
    {
        ...
        CommandBindings.Add(new CommandBinding(NavigationCommands.BrowseBack, (_, _) => GoBack(),
            (_, e) => e.CanExecute = !isTagView && !isDownloadView && ContextActionsAvailable && (isPodcastView ? podcastShowOpen : musicBrowse.CanGoBack || PlaylistList.SelectedItem is Playlist)));
    }
